...
\begin{tikzpicture}
	...
	\draw[white] (1, 1) node {5};
	\draw[white] (2, 2) node {4};
	\draw[white] (3, 3) node{3};
	\draw[white] (4, 4) node{2};
	\draw[white] (5, 5) node{1};
	\draw[white] (6, 6) node{10};
	\draw[white] (7, 7) node{9};
	\draw[white] (8, 8) node{8};
	\draw[white] (9, 9) node{7};
	\draw[white] (10, 10) node{6};
