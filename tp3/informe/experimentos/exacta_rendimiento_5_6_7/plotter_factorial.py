	...
	for line in dataFile:
		...
		if(ultima_cant_nodos != nodos):
			if(ultima_cant_nodos != -1):						
				...
				graphic_med_y_over_n.append(float(value / math.pow(ultima_cant_nodos, 5)))
				graphic_med_y_over_n_square.append(float(value / math.pow(ultima_cant_nodos, 6)))
				graphic_med_y_over_n_cube.append(float(value / math.pow(ultima_cant_nodos, 7)))
