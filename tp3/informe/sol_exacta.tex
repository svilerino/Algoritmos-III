...
Podemos observar que para el caso de alta densidad de aristas en los grafos, al dividir la funcion que expresa el tiempo en funcion de la entrada por varios polinomios de grados 1,2,3,4, el grafo sigue con un algo nivel de crecimiento, intentamos dividir la funcion por factorial y realizar el grafico $f(x/x!)$ pero dados los numeros nos explotaba el generador de graficos con overflow.