...
En el caso de densidad cuadr\'atica, la curva divida por $n^3$ es decreciente, y la curva dividida por $n^2$ es creciente, con lo cual la complejidad se sit\'ua en un orden entre \'estos. El hecho de que la curva cuadr\'atica se muestre creciente muestra que a medida que crece $n$, y la densidad de aristas del grafo crece $k$, las iteraciones que puede realizar la b\'usqueda local, lo cual coincide con nuestra complejidad te\'orica.
